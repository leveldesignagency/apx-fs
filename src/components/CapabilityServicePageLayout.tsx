...
function CapabilityListItem({ children, index }: { children: React.ReactNode; index: number }) {
  return (
    <ServiceItemReveal index={index} stepMs={50} className="contents">
              ...
              <div className="fs-capability-unified mt-0 sm:mt-1">
                ...
                <div className="fs-capability-inner fs-capability-inner--unified apx-site-table">
                  <div className="fs-capability-columns">
                    <Reveal className="fs-capability-column min-w-0" delayMs={80}>
                      <div>
                    ...
                    <Reveal className="fs-capability-column min-w-0" delayMs={140}>
                      <div>
                        <h2 className={sectionHeadingClass}>
                    ...
                    <Reveal className="fs-capability-column min-w-0" delayMs={200}>
                      <div>
                        <h2 className={sectionHeadingClass}>

          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="space-y-6 pl-8 md:pl-12">
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li><Link href="#" className="relative group hover:text-white transition-colors text-sm cursor-pointer pb-1" onClick={(e) => e.preventDefault()}>Access Control Systems<span className="absolute bottom-0 left-1/2 w-full h-0.5 transform -translate-x-1/2 scale-x-0 origin-center transition-transform duration-500 group-hover:scale-x-100" style={{ backgroundColor: 'white' }}></span></Link></li>
                <li><Link href="#" className="relative group hover:text-white transition-colors text-sm cursor-pointer pb-1" onClick={(e) => e.preventDefault()}>Intruder Alarm Systems<span className="absolute bottom-0 left-1/2 w-full h-0.5 transform -translate-x-1/2 scale-x-0 origin-center transition-transform duration-500 group-hover:scale-x-100" style={{ backgroundColor: 'white' }}></span></Link></li>
                <li><Link href="#" className="relative group hover:text-white transition-colors text-sm cursor-pointer pb-1" onClick={(e) => e.preventDefault()}>Fire Alarm Systems<span className="absolute bottom-0 left-1/2 w-full h-0.5 transform -translate-x-1/2 scale-x-0 origin-center transition-transform duration-500 group-hover:scale-x-100" style={{ backgroundColor: 'white' }}></span></Link></li>
                <li><Link href="#" className="relative group hover:text-white transition-colors text-sm cursor-pointer pb-1" onClick={(e) => e.preventDefault()}>Video Door Entry Systems<span className="absolute bottom-0 left-1/2 w-full h-0.5 transform -translate-x-1/2 scale-x-0 origin-center transition-transform duration-500 group-hover:scale-x-100" style={{ backgroundColor: 'white' }}></span></Link></li>
              </ul>
            </div>
